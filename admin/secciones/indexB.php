...
include ('../../app/controllers/secciones/listado_de_secciones_B.php');
?> 
            ...
            <div class="card card-outline card-secondary">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="createB.php" class="btn btn-dark"><i class="bi bi-plus-circle"></i>   Registrar estudiante</a>
                </div>
              </div>
              <div class="card-body">
            ...
            foreach ($secciones as $seccion) {
              ...
              <tr>
                ...
                <div class="btn-group" role="group" aria-label="Basic example">
                  <a href="showB.php?id=<?=$id_seccion;?>" type="button" class="btn btn-primary btn-sm"><i class="bi bi-eye"></i></a>
                  <a href="editB.php?id=<?=$id_seccion;?>" type="button" class="btn btn-warning btn-sm"><i class="bi bi-pencil-square" style ="color: white"></i></a>
                  <form action="<?=APP_URL;?>/app/controllers/secciones/indexB.php/delete.php" onclick="preguntar<?=$id_seccion;?>(event)" method="post" id="miFormulario<?=$id_seccion;?>">
