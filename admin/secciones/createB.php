  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container">
        ...
        <div class="row">
          <div class = "col-md-12">
            <form action="<?= APP_URL;?>/app/controllers/secciones/createB.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select name="nivel_id" id="" class="form-control">
                                    ...
                                    foreach($niveles as $nivele){ 
                                        ?>
                                         <option value="<?=$nivele['id_nivel'];?>" <?=$nivele['nivel']=="SEGUNDO" ? 'selected' : '';?>><?=$nivele['nivel'];?></option>
                                        <?php    
                                       }
                                    ?>
                                </select>
              ...
              <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                           ...
                           <a href="<?= APP_URL;?>/admin/secciones/indexB.php" class="btn btn-secondary">Cancelar</a>
                      </div>
                </div>
              </div>
      </form>
