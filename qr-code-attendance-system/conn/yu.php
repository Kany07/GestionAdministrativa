...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['student_name'], $_POST['course_section'], $_POST['tipo_empleado'])) {
        ...
        $tipoEmpleado = $_POST['tipo_empleado']; // Obtener el tipo de empleado del formulario POST

        try {
            // Preparar una declaración para insertar un nuevo estudiante en la base de datos
            $stmt = $conn->prepare("INSERT INTO tbl_student (student_name, course_section, generated_code, tipo_empleado) VALUES (:student_name, :course_section, :generated_code, :tipo_empleado)");
            ...
            $stmt->bindParam(":tipo_empleado", $tipoEmpleado, PDO::PARAM_STR); // Añadir el tipo de empleado 
